...
**Şu anki kapsama: ~72%** (22/32 modül)
...
- İş İzni (PTW) + LOTO
- **Ölçüm Yönetimi — Çekirdek Altyapı** (F3-001)

## Planlanmış Fonksiyonlar (FAZ 3-5)

- Ölçüm Orkestrasyonu Detayları (Gürültü, Toz, Titreşim, Işık — F3-002)
- Çevre İzleme (Ambient ölçümler — F3-003)
- Mevzuat Motoru (Yükümlülük, Uygunluk Değerlendirmesi — F4-001)
...
- [ ] `isg_measurement_result.exceeding_percentage` — compute field, store=True gerekli (şu an yok)
...
- isg_measurement_hygiene (parametre-özel alanlar)
...
1. **FAZ 3-002 isg_measurement_hygiene** — F3-001'in doğal devamı
...
- TASKS.md ✅ güncel
- CLAUDE.md ✅ güncel
- ARCHITECTURE.md ⚠️ güncelleme gerekli (F3-001 eklenmeli)
